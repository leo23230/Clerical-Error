...
public static class HelperUtilities
{
    ...
    {
        float radians = Mathf.Atan2(vector.y, vector.x); //pass in y and x value, returns angle in radians

        float degrees = radians * Mathf.Rad2Deg; //Mathf.Rad2Deg converts radians to degrees

        return degrees; //return the angle
...
/*    public static Vector3 GetSpawnPositionNearestToPlayer(Vector3 playerPosition)
    {
        ...
        Grid grid = currentRoom.instantiatedRoom.grid; //hold reference to grid component
